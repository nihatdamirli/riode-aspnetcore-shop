            ...
            Riode.$body
                ...
                .on("click", ".select-item i", function (e) {
                    $(e.currentTarget)
                        ...
                        .fadeOut(function () {
                            var e = $(this),
                                t = e.data("link");
                            t && t.toggleClass("active"), e.remove(),
                                $(".select-items").children().length < 2 && $(".select-items").hide();
                        }),
                        e.preventDefault();
                })
                ...
                .on("click", ".filter-items a", function (e) {
                    ...
                    t.hasClass("search-ul") ||
                        ...
                        (t.hasClass("filter-price") ? ($(this).parent().siblings().removeClass("active"), $(this).parent().toggleClass("active"),
